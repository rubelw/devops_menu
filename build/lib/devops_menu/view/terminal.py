...
from devops_menu.commons.string import *
from devops_menu.commons.io import print_safe
from devops_menu.commons.types import *
from devops_menu.entity import Menu, Command
from devops_menu.exceptions import EncodingError, SettingError
from devops_menu.view import i18n
import inspect
import re
...
class Terminal(object):
    def __init__(self, root_menu, host, user, executor, handler, width=None, page_size=None, _input=sys.stdin,
        ...
        :param handler: devops_menu.commons.terminal.TerminalHandler instance
        :param width:
        :param page_size:
        :param _input:
        :param _output:
